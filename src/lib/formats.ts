...
export const FORMATS: FormatInfo[] = [
  ...
  { id: 'ods', label: 'OpenDocument Spreadsheet', exts: ['ods', 'ots', 'fods'], kind: 'sheet', open: 'native', save: 'native', lossy: 'Cell styles, charts and conditional formatting are simplified in .ods.' },
